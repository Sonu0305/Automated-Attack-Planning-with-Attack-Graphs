...
- Add a scripted benchmark generator so the committed showcase can be regenerated with one command.
- Publish a GitHub Pages-friendly static version of the dashboard visuals.
- Add larger benchmark suites that force RL and stealth-aware planning to diverge even more strongly.
